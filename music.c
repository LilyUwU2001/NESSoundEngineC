...
// stores all song names
const byte name1[] = {67,101,108,105,110,97,0};
const byte artist1[] = {75,117,108,116,0};
const byte name2[] = {84,97,99,121,32,83,97,109,105,0};
const byte artist2[] = {76,97,100,121,32,80,97,110,107,0};
const byte name3[] = {84,101,109,112,116,97,116,105,111,110,0};
const byte artist3[] = {65,114,97,115,104,32,102,101,97,116,46,32,82,101,98,101,99,99,97,0};
const byte name4[] = {77,97,43,97,32,70,105,103,108,97,114,107,97,0};
const byte artist4[] = {65,107,99,101,110,116,0}; 
const byte name5[] = {83,116,97,114,100,117,115,116,32,83,112,101,101,100,119,97,121,32,80,97,115,116,0};
const byte artist5[] = {78,97,111,102,117,109,105,32,72,97,121,97,116,97,32,40,83,111,110,105,99,32,67,68,41,0};
const byte name6[] = {65,114,111,117,110,100,32,116,104,101,32,87,111,114,108,100,0};
const byte artist6[] = {65,84,67,0};
const byte name7[] = {83,119,101,101,116,32,68,114,101,97,109,115,0};
const byte artist7[] ={69,117,114,121,116,104,109,105,99,115,0};
const byte name8[] = {73,32,87,105,108,108,32,83,117,114,118,105,118,101,0};
const byte artist8[] = {71,108,111,114,105,97,32,71,97,121,110,111,114,0};
const byte name9[] = {84,101,99,104,110,111,32,83,121,110,100,114,111,109,101,0};
const byte artist9[] = {84,104,101,32,73,109,109,111,114,116,97,108,115,0};
const byte name10[] = {70,105,110,97,108,32,66,111,115,115,0};
const byte artist10[] = {89,117,107,111,32,84,97,107,101,104,97,114,97,32,40,77,101,103,97,32,77,97,110,32,54,41,32,0};
const byte name11[] = {89,101,115,116,101,114,100,97,121,0};
const byte artist11[] = {84,104,101,32,66,101,97,116,108,101,115,32,0}; 
const byte name12[] = {84,104,101,32,70,105,110,97,108,32,67,111,117,110,116,100,111,119,110,32,40,74,0x17,103,108,101,41,0}; 
const byte artist12[] = {69,117,114,111,112,101,0};
const byte name13[] = {83,116,97,103,101,32,67,108,101,97,114,0};
const byte artist13[] = {75,105,110,117,121,111,32,89,97,109,97,115,104,105,116,97,32,40,0x14,115,0x15,101,118,97,110,0x16,41,0};
...
const byte * name_tables[] = {name1, name2, name3, name4, name5, name6, name7, name8, name9, name10, name11, name12, name13};
const byte * artist_tables[] = {artist1, artist2, artist3, artist4, artist5, artist6, artist7, artist8, artist9, artist10, artist11, artist12, artist13};
const byte noise_channel[] = {1, 0, 1, 2, 2, 1, 0, 1, 1, 0, 1, 1, 1};
  ...
  if (music_ptr) {
    ...
    while (cur_duration == 0) {
      ...
      if ((note & 0x80) == 0) {
        ...
        if (note+transpose >= BASS_NOTE || (chs & 4)) {
          int period = NOTE_TABLE[note+transpose & 63];
          // see which pulse generator is free
          if (!(chs & 1)) {
            if (duty1 == 0) {
            APU_PULSE_DECAY(0, period, DUTY_12, length1, initvol1);
            }
            if (duty1 == 1) {
            APU_PULSE_DECAY(0, period, DUTY_25, length1, initvol1);
            }
            if (duty1 == 2) {
            APU_PULSE_DECAY(0, period, DUTY_50, length1, initvol1);
            }
            if (duty1 == 3) {
            APU_PULSE_DECAY(0, period, DUTY_75, length1, initvol1);
            }
            if (noise_channel[music_index] == 0) {
            APU_NOISE_DECAY(30, 2, 10);
            noipos = 7;
            }
            sq1pos = 7;
            chs |= 1;
            ...
            if (duty2 == 0) {
            APU_PULSE_DECAY(1, period, DUTY_12, length2, initvol2);
            }
            if (duty2 == 1) {
            APU_PULSE_DECAY(1, period, DUTY_25, length2, initvol2);
            }
            if (duty2 == 2) {
            APU_PULSE_DECAY(1, period, DUTY_50, length2, initvol2);
            }
            if (duty2 == 3) {
            APU_PULSE_DECAY(1, period, DUTY_75, length2, initvol2);
            }
            if (noise_channel[music_index] == 1) {
            APU_NOISE_DECAY(30, 2, 10);
            noipos = 7;
            }
            sq2pos = 7;
          ...
          int period = note_table_tri[note+transpose & 63];
          APU_TRIANGLE_LENGTH(period, lengthtri);
          if (noise_channel[music_index] == 2) {
          APU_NOISE_DECAY(30, 2, 10);
          noipos = 7;
          }
          tripos = 7;
...
void put_title(int song) {
  ppu_off();
  put_str(NTADR_A(4,25), "                           ");
  put_str(NTADR_A(4,26), "                           ");
  put_str(NTADR_A(2,25), song_symbol);
  put_str(NTADR_A(2,26), artist_symbol);
  put_str(NTADR_A(4,25), name_tables[song]);
  put_str(NTADR_A(4,26), artist_tables[song]);
  ppu_on_all();
}
...
void main(void)
{
  ...
  put_str(NTADR_A(3,7), "DUTY/PULSE 2-");
  put_str(NTADR_A(3,8), "LENGTH/PULSE 1-");
  put_str(NTADR_A(3,9), "LENGTH/PULSE 2-");
  put_str(NTADR_A(3,10), "LENGTH/TRIANGLE-");
  put_str(NTADR_A(3,11), "INITIAL VOLUME/P1-");
  put_str(NTADR_A(3,12), "INITIAL VOLUME/P2-");
  put_str(NTADR_A(3,14), "SQ1 SQ2 TRI NOI");
  put_str(NTADR_A(3,15), " _   _   _   _ ");
  put_str(NTADR_A(3,16), " |   |   |   | ");
  put_str(NTADR_A(3,17), " |   |   |   | ");
  put_str(NTADR_A(3,18), " |   |   |   | ");
  put_str(NTADR_A(3,19), " |   |   |   | ");
  put_str(NTADR_A(3,20), " |   |   |   | ");
  put_str(NTADR_A(3,21), " |   |   |   | ");
  put_str(NTADR_A(3,22), " |   |   |   | ");
  put_str(NTADR_A(3,23), " ,   ,   ,   , ");
  
  put_str(NTADR_A(2,2), "ADRIAN's SOUND ENGINE - v2.1");
  ...
  while (1) {
    ...
    pal_col(1,0x1F);	// fuchsia
    pal_col(2,0x26);	// grey
    pal_col(3,0x3F);	// white
    
    oam_off = oam_spr(32+0, 184-8*sq1pos, 0x7F, 2, oam_off);
    oam_off = oam_spr(64+0, 184-8*sq2pos, 0x7F, 0, oam_off);
    oam_off = oam_spr(96+0, 184-8*tripos, 0x7F, 1, oam_off);
    oam_off = oam_spr(128+0, 184-8*noipos, 0x7F, 3, oam_off);
    ...
    oam_off = oam_spr(16+0, 31+8*menu, 0x18, 3, oam_off);
    
    oam_off = oam_spr(40+24, 31, '0'+(music_index >> 4), 2, oam_off);
    oam_off = oam_spr(40+32, 31, '0'+(music_index & 0xf), 2, oam_off);
    
    oam_off = oam_spr(80+24, 39, '0'+(transpose >> 4), 2, oam_off);
    oam_off = oam_spr(80+32, 39, '0'+(transpose & 0xf), 2, oam_off);
    
    oam_off = oam_spr(104+24, 47, '0'+(duty1 >> 4), 2, oam_off);
    oam_off = oam_spr(104+32, 47, '0'+(duty1 & 0xf), 2, oam_off);
    
    oam_off = oam_spr(104+24, 55, '0'+(duty2 >> 4), 2, oam_off);
    oam_off = oam_spr(104+32, 55, '0'+(duty2 & 0xf), 2, oam_off);
    
    oam_off = oam_spr(120+24, 63, '0'+(length1 >> 4), 2, oam_off);
    oam_off = oam_spr(120+32, 63, '0'+(length1 & 0xf), 2, oam_off);
    
    oam_off = oam_spr(120+24, 71, '0'+(length2 >> 4), 2, oam_off);
    oam_off = oam_spr(120+32, 71, '0'+(length2 & 0xf), 2, oam_off);
    
    oam_off = oam_spr(128+24, 79, '0'+(lengthtri >> 4), 2, oam_off);
    oam_off = oam_spr(128+32, 79, '0'+(lengthtri & 0xf), 2, oam_off);
    
    oam_off = oam_spr(128+40, 87, '0'+(initvol1 >> 4), 2, oam_off);
    oam_off = oam_spr(128+48, 87, '0'+(initvol1 & 0xf), 2, oam_off);
    
    oam_off = oam_spr(128+40, 95, '0'+(initvol2 >> 4), 2, oam_off);
    oam_off = oam_spr(128+48, 95, '0'+(initvol2 & 0xf), 2, oam_off);
    ...
    if(pad & PAD_RIGHT && menu == 0 && frames >= 10){
    	music_index += 1;  
        frames = 0;
    }
    if(pad & PAD_LEFT && menu == 1 && frames >= 10){
    	transpose -= 1;
      	frames = 0;
    }
    
    if(pad & PAD_RIGHT && menu == 1 && frames >= 10){
    	transpose += 1;  
        frames = 0;
    }
    if(pad & PAD_LEFT && menu == 2 && duty1 > 0 && frames >= 10){
    	duty1 -= 1;
      	frames = 0;
    }
    
    if(pad & PAD_RIGHT && menu == 2 && duty1 < 3 && frames >= 10){
    	duty1 += 1;  
        frames = 0;
    }
    if(pad & PAD_LEFT && menu == 3 && duty2 > 0 && frames >= 10){
    	duty2 -= 1;
      	frames = 0;
    }
    
    if(pad & PAD_RIGHT && menu == 3 && duty2 < 3 && frames >= 10){
    	duty2 += 1;  
        frames = 0;
    }
    if(pad & PAD_LEFT && menu == 4 && frames >= 10){
    	length1 -= 1;
      	frames = 0;
    }
    
    if(pad & PAD_RIGHT && menu == 4 && frames >= 10){
    	length1 += 1;  
        frames = 0;
    }
    if(pad & PAD_LEFT && menu == 5 && frames >= 10){
    	length2 -= 1;
      	frames = 0;
    }
    
    if(pad & PAD_RIGHT && menu == 5 && frames >= 10){
    	length2 += 1;  
        frames = 0;
    }
    if(pad & PAD_LEFT && menu == 6 && frames >= 10){
    	lengthtri -= 1;
      	frames = 0;
    }
    
    if(pad & PAD_RIGHT && menu == 6 && frames >= 10){
    	lengthtri += 1;  
        frames = 0;
    }
    if(pad & PAD_LEFT && menu == 7 && frames >= 10){
    	initvol1 -= 1;
      	frames = 0;
    }
    
    if(pad & PAD_RIGHT && menu == 7 && frames >= 10){
    	initvol1 += 1;  
        frames = 0;
    }
    if(pad & PAD_LEFT && menu == 8 && frames >= 10){
    	initvol2 -= 1;
      	frames = 0;
    }
    
    if(pad & PAD_RIGHT && menu == 8 && frames >= 10){
    	initvol2 += 1;  
        frames = 0;
    }
    if(pad & PAD_UP && menu > 0 && frames >= 10){
    	menu -= 1;  
        frames = 0;
    }
    if(pad & PAD_DOWN && menu < 8 && frames >= 10){
    	menu += 1;  
        frames = 0;
    }
    if(frames > 60) {
